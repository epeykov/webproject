...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'article_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'article_id' => 1,
            'created' => '2017-07-29 11:07:06',
            'modified' => '2017-07-29 11:07:06'
        ],
    ];
}
